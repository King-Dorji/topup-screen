...
export default function MpesaPayIframe() {
  ...
  useEffect(() => {
    const handleKey = (e: KeyboardEvent) => {
      if (e.key === "Escape" && phase !== "success") handleClose();
    };
  ...
  return (
    /* Backdrop — owned by Mpesa's page, not Betika */
    <div
    ...
    >
      {/* Card shell — also owned by Mpesa's page */}
      <div
        className="modal-enter w-[min(400px,100%)] rounded-[20px] bg-white shadow-[0_32px_80px_rgba(0,0,0,0.5)] overflow-hidden"
        ...
        <div className="px-6 py-5">
          ...
          {phase === "success" && (
            <div className="fade-in text-center py-1 pb-2">
              <p className="m-0 text-[14px] text-grey-900 font-semibold">KES {amount.toLocaleString()} deposited successfully</p>
